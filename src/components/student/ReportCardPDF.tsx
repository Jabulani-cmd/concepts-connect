...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* Header */
  .header { text-align: center; border-bottom: 3px double #6508c5; padding-bottom: 12px; margin-bottom: 16px; }
  .school-logo { width: 86px; height: 86px; object-fit: contain; margin: 0 auto 6px; display: block; }
  .school-name { font-size: 22pt; font-weight: bold; color: #6508c5; letter-spacing: 1px; text-transform: uppercase; }
  ...
  .report-title { font-size: 14pt; font-weight: bold; margin-top: 10px; color: #3f3f3f; text-transform: uppercase; letter-spacing: 2px; border: 2px solid #6508c5; display: inline-block; padding: 4px 20px; }
  ...
  .results-table th { background: #6508c5; color: #fff; padding: 8px 10px; text-align: left; font-weight: 600; }
  ...
  .results-table .total-row { background: #6508c5 !important; color: #fff; font-weight: bold; }
  ...
  .summary-box h3 { font-size: 11pt; color: #6508c5; border-bottom: 1px solid #dee2e6; padding-bottom: 6px; margin-bottom: 8px; }
  ...
  .grading-key h3 { font-size: 10pt; color: #6508c5; margin-bottom: 6px; }
  ...
  .print-btn { position: fixed; top: 20px; right: 20px; padding: 10px 24px; background: #6508c5; color: #fff; border: none; border-radius: 6px; font-size: 14px; cursor: pointer; z-index: 999; }
