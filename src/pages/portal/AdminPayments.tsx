    ...
    try {
      const { data, error } = await supabase.functions.invoke("ai-parent-message", {
        body: {
          ...
          context: `There are ${expiredCount + subs.filter(s => s.status === "pending").length} unpaid families. Write a warm, brief reminder to renew portal subscription at Concepts Learning Academy. Mention plans start at US$ 10/month or US$ 25/term, with the current ZiG equivalent shown in the portal.`,
        },
      });
      ...
      setAiMessage("Dear Parent, this is a friendly reminder to renew your portal subscription so your child can continue accessing learning materials and the timetable. Plans start at US$ 10/month or US$ 25/term, with the current ZiG equivalent shown in the portal. | Concepts Learning Academy");
    } finally {
      setAiLoading(false);
    }
  }
